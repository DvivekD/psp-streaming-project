...
module.exports = {
    ...
    */
    ...
    "saveMp4": function(id, callback, extended) {
        ...
        let dlcmd = `yt-dlp --cookies cookies.txt --extractor-args "youtube:player_client=mweb" -f "bestvideo[height<=720][ext=mp4]+bestaudio[ext=m4a]/best[ext=mp4]/best" "https://www.youtube.com/watch?v=${id}" -o "${__dirname}/../assets/${id}.mp4"`;
